...
export async function getHatThought(
  answersSoFar: string[],
...
Genera un pensamiento breve (máximo 15 palabras). Solo devuelve la frase entre comillas.`;
...
export async function getFinalJudgment(
